=== Fast Food Pizza WordPress Theme ===
...
= 0.2 =
* Removed Pizza WordPress Theme from screenshot.
...
= 0.2.2 =
* Added condition for slider image in home-page.php file.
* Added theme color option.

= 0.2.3 =
* Changed blog post layout.
* Changed sidebar layout.

= 0.2.4 =
* Resolved error from theme-color-option.php.
* Added enable/disable sticky header option.
* Added POT file.

= 0.2.5 =
* Added web fonts file.
* Resolved css error in sidebar widget and menus.
* Updated POT file.

== Resources ==

Fast Food Pizza WordPress Theme, Copyright 2022 Buywptemplates
Fast Food Pizza WordPress Theme is distributed under the terms of the GNU GPL
...
* PxHere Images
  ...
  License: CC0 1.0 Universal (CC0 1.0)
  Source: https://pxhere.com/en/photo/1202870

  Slider Image
  License: CC0 1.0 Universal (CC0 1.0)
  Source: https://pxhere.com/en/photo/16264

  Slider Image
  License: CC0 1.0 Universal (CC0 1.0)
  Source: https://pxhere.com/en/photo/608902

  Slider Image
  License: CC0 1.0 Universal (CC0 1.0)
  Source: https://pxhere.com/en/photo/609744

  Slider Image
  License: CC0 1.0 Universal (CC0 1.0)
  Source: https://pxhere.com/en/photo/918162

  Slider Side Image
  License: CC0 1.0 Universal (CC0 1.0)
  Source: https://pxhere.com/en/photo/697151
  ...
  Product Image, 
  License: CC0 1.0 Universal (CC0 1.0)
  Source: https://pxhere.com/en/photo/1113038