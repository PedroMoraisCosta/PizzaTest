...
function fast_food_pizza_scripts() {
	...
	$fast_food_pizza_custom_css = '
		p,span{
		    ...
		    font-size: '.esc_html($fast_food_pizza_paragraph_font_size).';
		}
		a{
